...
while 1:
    ...
    print("""{}
     ______                         _     
      ______                 __       _ _ _     
 |  ____|               / _|     | | | |    
 | |____  ___ _ __ ___ | |_ _   _| | | |___ 
 |  __\ \/ / | '_ ` _ \|  _| | | | | | / __|
 | |___>  <| | | | | | | | | |_| | | | \__ \
 |_____/_/\_\_| |_| |_|_|  \__,_|_|_|_|___/
                                                 
    
    Sms: {}           {}by {}@emofulls\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder (Normal tavsiye etmem)\n\n 2- SMS Gönder (Turbo dene ve gör)\n\n 3- Çıkıcaksan çık\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Hatalı giriş yaptın mal. Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
